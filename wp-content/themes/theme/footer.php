                ...
                <footer class="pb-50  pt-70 pos-relative">
                        ...
                        <div class="container-fluid">
                                ...
                                <?php } 
                                if (isset($con_footer['address_field']['title']) && isset($con_footer['address_field']['title_value']) && !empty($con_footer['address_field']['title'])&& !empty($con_footer['address_field']['title_value'])) { ?>
                                        <div class="pt-30">
                                ...
                                <?php } 
                                if (isset($con_footer['contact_field']['title']) && isset($con_footer['contact_field']['title_value']) && !empty($con_footer['contact_field']['title'])&& !empty($con_footer['contact_field']['title_value'])) { ?>
                                        <div class="pt-30">
                                ...
                                <?php } 
                                if (isset($con_footer['email_field']['title']) && isset($con_footer['email_field']['title_value']) && !empty($con_footer['email_field']['title'])&& !empty($con_footer['email_field']['title_value'])) { ?>
                                        <div class="pt-30">
                                ...
                                <?php } 
                                if (isset($con_footer['copy_right']['right']) && !empty($con_footer['copy_right']['right'])) { ?>
